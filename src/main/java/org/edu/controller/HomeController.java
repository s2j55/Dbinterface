...
public class HomeController {
	...
	public String home(Locale locale, Model model) throws Exception {
		...
		//제네릭타입-List<T>를 사용하는 이유는 실행히(runtime)에서만 발생될 수 있는 에러를
		//서버에 올리기 전에 미리 이클립스 단에서 컴파일 시 확인 가능하기 위해서
